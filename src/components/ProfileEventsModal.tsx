      ...
      >
        ...
        <div className="flex-1 overflow-auto p-3">
          ...
          <div className="grid grid-cols-4 gap-2 mb-4">
            ...
            <div className="bg-gray-800 p-2 rounded">
              <div className="text-xs text-gray-400">Result Bytes</div>
              <div className="text-sm font-semibold text-white">{formatBytes(Number(selectedEntry.result_bytes) || 0)}</div>
            </div>
            <div className="bg-gray-800 p-2 rounded">
            ...
            <div className="bg-gray-800 p-2 rounded">
              ...
              <div className="text-sm font-semibold text-white">{formatBytes(Number(selectedEntry.written_bytes) || 0)}</div>
            </div>
          </div>
