...
import { fetchPartsDistinctValues } from '../services/api';
...
const FILTERABLE_FIELDS = [
  ...
  { field: 'disk_name', label: 'Disk Name' },
];
...
export function PartsFilterPanel({ filters, onFilterChange, onClearFilter, onClearAll }: PartsFilterPanelProps) {
  ...
  const loadFieldValues = async (field: string) => {
    ...
    try {
      const values = await fetchPartsDistinctValues(field);
